        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__OrderDet__08D097A37D035CC6");
            ...
            modelBuilder.Entity<PetDetail>(entity =>
            {
                entity.HasKey(e => e.PetId)
                    .HasName("PK__PetDetai__48E5386219BCBD1F");

                entity.ToTable("PetDetail");

                entity.HasIndex(e => e.ProductId, "UQ__PetDetai__B40CC6CCB2979D7C")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Product)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PetDetail__Produ__300424B4");
            });
