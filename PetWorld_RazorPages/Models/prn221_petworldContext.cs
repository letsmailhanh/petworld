        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__OrderDet__08D097A3C4F6EA19");
            ...
            modelBuilder.Entity<PetDetail>(entity =>
            {
                entity.HasKey(e => e.PetId)
                    .HasName("PK__PetDetai__48E538624DCFD3BA");

                entity.ToTable("PetDetail");

                entity.HasIndex(e => e.ProductId, "UQ__PetDetai__B40CC6CCAB2EA068")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Product)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PetDetail__Produ__3F466844");
            });
